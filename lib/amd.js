...
Sock.ev.on("connection.update", async (update) => {
  ...
  if (connection === "open") {
    ...
    let isAllowedUser = /2348039607375|2347041620617|2348052944641/g.test(userId);
