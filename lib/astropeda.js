...
async function sendAnimeReaction(_0x5c448a, _0x46face = "punch", _0x50961f = "", _0x426154 = "") {
  try {
    ...
    return await _0x5c448a.error(_0x1b7c90 + "\nERROR AT : /lib/astropeda.js/sendAnimeReaction()\n\ncommand: " + _0x46face);
  }
}
async function sendGImages(_0x4a189d, _0x4eee7c, _0x205b7c = caption, _0x1caf0d = "") {
  try {
    ...
    return console.log("./lib/astropeda.js/sendGImages()\n", _0x36d8e7);
  }
}
...
async function forwardMessage(_0x56dbe1, _0x5eaf75, _0x561de2 = "") {
  ...
  if (_0x3af25e) {
    try {
      await Asta.bot.relayMessage(_0x56dbe1, _0x3af25e, {
...
async function randomeFunfacts(_0x1be35e) {
  try {
    ...
    msg.error(_0x1147af);
    console.log("./lib/astropeda.js/randomeFunfacts()\n", _0x1147af);
  }
}
async function audioEditor(_0x1ef339, _0x567a0f = "bass", _0x730356 = "") {
  ...
  try {
    ...
    return console.log("./lib/astropeda.js/audioEditor()\n", _0x48606a);
  }
}
async function send(_0x38fbe8, _0x3e1faf, _0x38564b = {
  ...
  try {
    ...
    console.log("./lib/astropeda.js/send()\n", _0x164757);
  }
}
async function react(_0x460a9b, _0x131f21, _0x1b76d0 = "") {
  try {
    ...
    console.log("./lib/astropeda.js/react()\n", _0x102c7a);
  }
}
let note = {
...
async function sendWelcome(_0x50ffa3, _0x3417a5 = "", _0x27d774 = "", _0x3fa550 = "", _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    console.log("./lib/astropeda.js/sendWelcome()\n", _0x30453c);
  }
}
  ...
  try {
    ...
    if (_0x2b48e0 && _0x2b48e0.includes(":")) {
      ...
      if (_0x2d4089.toLowerCase() === "richel" || _0x2d4089 === "1") {
        ...
        _0x30713a = 34;
      } else if (_0x2d4089.toLowerCase() === "astro" || _0x2d4089 === "36") {
        _0x30713a = 35;
...
setMention.get = async _0x2cdc1a => {
  try {
    ...
    if (_0x584f1d.get) {
      ...
      return await _0x2cdc1a.reply("*You did'nt set mention message yet!*\n*please Check: https://github.com/SuhailTechInfo/Asta-Md/wiki/mention*");
    }
  } catch (_0x4535a8) {
    ...
    for (const _0x55bb42 of _0x55b13f) {
      ...
      if (_0x1cf682.length >= 1) {
        ...
        if (_0x243ab6 !== -1) {
          ...
          let _0x192321 = /suhail|amd|message|chat/gi.test(_0xef10c6);
          if (!_0x4656bb[_0x192321 ? "astro" : _0xef10c6]) {
            _0x4656bb[_0x192321 ? "astro" : _0xef10c6] = [];
          }
        }
        const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== "");
        _0xef10c6 = /suhail|amd|message|chat/gi.test(_0xef10c6) ? "astro" : _0xef10c6;
        if (_0x26ebaf.length > 0) {
          if (_0x22e9cc.includes(_0xef10c6)) {
            ...
            _0x4656bb[/suhail/gi.test(_0xef10c6) ? "astro" : "text"].push(_0x26ebaf.join(" "));
          }
        }
      }
      _0xef10c6 = null;
...
setMention.cmd = async (_0x501ec5, _0x2a1c43 = "") => {
  try {
    ...
    if (global.AmdOfficial !== "yes") {
      return;
    }
    if (_0x2a1c43 === "get" || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
      setMention.get(_0x501ec5);
    } else if (!_0x2a1c43) {
      _0x501ec5.reply("_Read wiki to set mention message https://github.com/SuhailTechInfo/Asta-Md/wiki/mention_", {}, "amd");
...
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionsuhail && (_0x373988.mentionedJid.includes("@2348039607375@s.whatsapp.net") || _0x373988.mentionedJid.includes("@2349027862116@s.whatsapp.net") || /@2348039607375|@2349027862116/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AmdOfficial !== "yes") {
        return;
      }
...
setFilter.check = async (_0x26e5fd, _0x1061b1 = "") => {
  try {
    ...
    if (_0x148446[_0x1061b1]) {
      _0x26e5fd.reply(_0x148446[_0x1061b1], {}, "amd", _0x26e5fd);
    }
  } catch (_0x5ce3b) {
