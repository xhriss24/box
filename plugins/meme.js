...
const { sleep, smd, Config } = require("../lib/");
...
smd(
  ...
  async (_0x2e919e, _0x3211d9) => {
    try {
      ...
      const _0x8d5fe7 = 700;
      const _0x5c1e91 = 4;
      let _0x3516c1 = await addTextToImage(
        _0x1fe1f4,
        _0x6eae84,
        " " + _0x3211d9,
        _0x37de91,
...
smd(
  ...
  async (_0x196aaf, _0xb868e4) => {
    try {
      ...
      const _0x1b6b56 = 3;
      const _0x19aff6 = "35";
      let _0x458c49 = await addTextToImage(
        _0x45716c,
        _0x349967,
        "  " + _0xb868e4,
        _0x205145,
...
smd(
  ...
  async (_0x3e4e5f, _0xc96ca7) => {
    try {
      ...
      const _0x4bdade = 3;
      const _0x539a5e = "30";
      let _0xb1f16a = await addTextToImage(
        _0x340a07,
        _0x57864f,
        "  " + _0xc96ca7,
        _0x2df546,
...
smd(
  ...
  async (_0x102280, _0x5103d0) => {
    try {
      ...
      const _0x47429e = 900;
      const _0x5461e5 = 5;
      let _0x499f7b = await addTextToImage(
        _0x17181a,
        _0x3ec84e,
        "\t" + _0x5103d0,
        _0x8750aa,
...
smd(
  ...
  async (_0x27b8ff, _0x53affd) => {
    try {
      ...
      const _0x59eae9 = 3;
      const _0x48235d = "20";
      let _0x21dd56 = await addTextToImage(
        _0xf83242,
        _0x564c44,
        "  " + _0x53affd,
        _0xabdc6f,
...
smd(
  ...
  async (_0x510e3f, _0x338922) => {
    try {
      ...
      const _0x3def83 = 4;
      const _0x2f0120 = "35";
      let _0x5f154f = await addTextToImage(
        _0x395e,
        _0x40e38d,
        "  " + _0x338922,
        _0x3ffcaa,
...
smd(
  ...
  async (_0x570869, _0x5706ad) => {
    try {
      ...
      const _0x104f3a = 4;
      const _0x2bbc60 = "20";
      let _0x2c7d13 = await addTextToImage(
        _0x376671,
        _0x421d98,
        "  " + _0x5706ad,
        _0x4fbe21,
...
smd(
  ...
  async (_0x3faf31, _0x336e80) => {
    try {
      ...
      const _0x124113 = 5;
      const _0x22ac13 = "20";
      let _0xc5a93c = await addTextToImage(
        _0x2cb643,
        _0x4909fc,
        "  " + _0x336e80,
        _0x396f03,
